...
public class mLog {
    ...
    public static void v(Object contentObj) {
        if (!DebugUtils.isDebugBuild()) {
            return;
        }
    ...
    public static void v(Object contentObj, Throwable e) {
        if (!DebugUtils.isDebugBuild()) {
            return;
        }
    ...
    public static void w(Object contentObj) {
        if (!DebugUtils.isDebugBuild()) {
            return;
        }
        String tag = getTag();
    ...
    public static void w(Object contentObj, Throwable e) {
        if (!DebugUtils.isDebugBuild()) {
            return;
        }
    ...
    public static void wtf(Object contentObj) {
        if (!DebugUtils.isDebugBuild()) {
            return;
        }
    ...
    public static void wtf(Object contentObj, Throwable e) {
        if (!DebugUtils.isDebugBuild()) {
            return;
        }
